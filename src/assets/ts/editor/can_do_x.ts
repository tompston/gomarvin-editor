...
export function canCreateNewEndpoint(existing_controllers: string[], new_controller_name: string): boolean {
  if (
...
export function canCreateNewBodyField(existing_body_fields: string[], new_body_field: string): boolean {
  if (
