...
<template>
  <div class="endpoint">
    <div class="endpoint__info">
      ...
      <!-- Endpoint URL param -->
      <div
        v-for="url_param in endpoint.url_params"
        v-bind:key="url_param"
        class="endpoint_input_grid"
      >
  ...
  <div class="p-2 mt-4" v-if="detailsAreShown">
    <!-- Single Body field -->
    <div>
      <div class="fs-6 mb-8 mt-2 disable-text-select">Body</div>
      <div class="grid gap-8 endpoint__body">
        ...
        <div v-if="!new_endpoint">
          <div class="flex both-100">
            <div class="flex gap-6 flex-center mt-6">
              <button
                class="flex-center w-30 h-30 temp-main-col-1 height-100 border-rad-5"
                @click="wantsToDeleteEndpoint = !wantsToDeleteEndpoint"
              >
                <DeleteSvg dims="15" fill="white" class="qwe" />
              </button>
