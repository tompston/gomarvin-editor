...
<template>
  <div class="endpoint">
    <div class="endpoint__info">
      ...
      <div class="h-full">
        <div>
          <input type="text" class="mevi" placeholder="controller_name" v-model="endpoint.controller_name" @input="
    ...
    <button v-if="!new_endpoint" class="endpoint__expander" @click="detailsAreShown = !detailsAreShown">
      <div class="flex-center">
        <svg class="opacity-30" width="27" height="8" viewBox="0 0 25 18" fill="none"
