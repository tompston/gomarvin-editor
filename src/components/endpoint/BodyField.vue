...
<template>
  <div class="endpoint_body_grid">
    ...
    <div>
      <div class="code dropdown__1_value" @click="body_fieldtype_dropdown_is_shown = !body_fieldtype_dropdown_is_shown">
        {{ body_param.type }}
      </div>
      <Dropdown1 :is_shown="body_fieldtype_dropdown_is_shown" :options="BodyFieldTypes" :value="body_param.type"
    ...
    <button v-if="!new_endpoint" class="flex-center text-col-6 delete_body_param border-rad-5 border-1-3"
    ...
    <button v-if="new_endpoint" class="flex-center create__endpoint_btn"
