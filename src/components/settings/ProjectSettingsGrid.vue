  ...
  <div class="settings__project_info">
    ...
    <div class="settings__project_info_value_label_grid">
      ...
      <div class="settings__project_info_value">
        ...
        <InputErrBox
          msg="Config version should be float!"
    ...
    <div class="settings__project_info_value_label_grid">
      ...
      <div class="settings__project_info_value">
        <div @click="db_dropdown_is_shown = !db_dropdown_is_shown">{{ project_info.db_type }}</div>
        <Dropdown1
    ...
    <div class="settings__project_info_value_label_grid">
      ...
      <div class="settings__project_info_value">
        ...
        >{{ project_info.gomarvin_version }}</div>
        <Dropdown1
    ...
    <div class="settings__project_info_value_label_grid">
      ...
      <div class="settings__project_info_value">
        <div @click="go_v_dropdown_is_shown = !go_v_dropdown_is_shown">{{ project_info.go_version }}</div>
        <Dropdown1
